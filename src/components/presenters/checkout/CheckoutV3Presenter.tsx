            ...
            <main className="mx-auto max-w-md px-4 pt-6 pb-44">
                ...
                <section className="mt-10">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold font-['Hind_Vadodara']">Månedens tema</h2>
                    </div>

                    <div className="bg-gray-50 rounded-2xl overflow-hidden">
                        <div className="p-4">
                            <p className="text-sm text-gray-700 mb-4 leading-relaxed">
                                Hver måned får du et nytt tema som hjelper deg å holde fokus og styrke transformasjonen din:
                            </p>
                            <div className="space-y-3">
                                {[
                                    { month: 'Juli', theme: 'Sommer, ferie og fleksibilitet' },
                                    { month: 'August', theme: 'Vanebygging og balanse' },
                                    { month: 'September', theme: 'Struktur og planlegging' },
                                    { month: 'Oktober', theme: 'Søvn og hormoner' },
                                    { month: 'November', theme: 'Tarmhelse og hormoner' },
                                ].map(({ month, theme }) => (
                                    <div key={month} className="flex items-center gap-3">
                                        <span className="text-sm font-semibold text-gray-900 w-24 shrink-0">{month}</span>
