...
import type { PlanType } from '@/containers/checkout/CheckoutContainer';
...
const CheckoutPresenter: React.FC<CheckoutPresenterProps> = ({
  selectedPlan,
  plans,
  onPlanChange,
  timeRemaining,
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-md px-4 pt-6 pb-44">
        ...
        <div className="mt-6">
          ...
          >
            <span>{`Start ${selectedPlan === '6month' ? '6 mnd' : '1 mnd'} nå`}</span>
